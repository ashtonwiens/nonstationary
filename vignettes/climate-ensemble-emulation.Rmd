---
title: "climate-ensemble-emulation"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{climate-ensemble-emulation}
...
par(mfrow=c(1,5), mar=c(1,0.5,2,0.5))
...
Simulation from cholesky decomposition of the covariance matrix
